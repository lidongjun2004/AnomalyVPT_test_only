...
_C.MODEL.VP_LENGTH = 0
_C.MODEL.PATCH_SIZE = 14
_C.MODEL.MODEL_NAME = "ViT-L-14-336"
...
_C.OPTIM0.NAME = "adam"
_C.OPTIM0.LR = 0.0003
_C.OPTIM0.WEIGHT_DECAY = 5e-4
_C.OPTIM0.MOMENTUM = 0.9
_C.OPTIM0.SGD_DAMPNING = 0
_C.OPTIM0.SGD_NESTEROV = False
_C.OPTIM0.RMSPROP_ALPHA = 0.99
# The following also apply to other
# adaptive optimizers like adamw
_C.OPTIM0.ADAM_BETA1 = 0.9
_C.OPTIM0.ADAM_BETA2 = 0.999
# STAGED_LR allows different layers to have
# different lr, e.g. pre-trained base layers
# can be assigned a smaller lr than the new
# classification layer
_C.OPTIM0.STAGED_LR = False
_C.OPTIM0.NEW_LAYERS = ()
_C.OPTIM0.BASE_LR_MULT = 0.1
# Learning rate scheduler
_C.OPTIM0.LR_SCHEDULER = "single_step"
# -1 or 0 means the stepsize is equal to max_epoch
_C.OPTIM0.STEPSIZE = (-1, )
_C.OPTIM0.GAMMA = 0.1
_C.OPTIM0.MAX_EPOCH = 10
# Set WARMUP_EPOCH larger than 0 to activate warmup training
_C.OPTIM0.WARMUP_EPOCH = -1
# Either linear or constant
_C.OPTIM0.WARMUP_TYPE = "linear"
# Constant learning rate when type=constant
_C.OPTIM0.WARMUP_CONS_LR = 1e-5
# Minimum learning rate when type=linear
_C.OPTIM0.WARMUP_MIN_LR = 1e-5
# Recount epoch for the next scheduler (last_epoch=-1)
# Otherwise last_epoch=warmup_epoch
_C.OPTIM0.WARMUP_RECOUNT = True
