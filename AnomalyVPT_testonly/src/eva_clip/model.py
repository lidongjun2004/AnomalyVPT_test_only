...
from .eva_vit_model import EVAVisionTransformer, EVAVisionPromptTransformer
...
def _build_vision_tower(
    ...
    if prompt_cfg.vision_prompt_layer_idx is not None and vision_cfg.eva_model_name:
        vision_heads = vision_cfg.width // vision_cfg.head_width
        norm_layer = LayerNorm
        
        visual = EVAVisionPromptTransformer(
